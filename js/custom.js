$(document).ready(function(e) {   
    ...
    $('input').click(function() {
        ...
        if($('#parteifilter5').is(':checked')) { 
            $('#0').css('fill','rgba(223, 4, 4,1.0)')
            $('#1').css('fill','rgba(223, 4, 4,0.85)')
            $('#2').css('fill','rgba(223, 4, 4,0.7)')
            $('#3').css('fill','rgba(223, 4, 4,0.6)')
            $('#4').css('fill','rgba(223, 4, 4,0.55)')
            $('#5').css('fill','rgba(223, 4, 4,0.5)')
            $('#6').css('fill','rgba(223, 4, 4,0.45)')
            $('#7').css('fill','rgba(223, 4, 4,0.4)')
            $('#8').css('fill','rgba(223, 4, 4,0.3)')
            $('#9').css('fill','rgba(223, 4, 4,0.35)')
            $('#10').css('fill','rgba(223, 4, 4,0.2)')
            $('#11').css('fill','rgba(223, 4, 4,0.25)')            
        }
        ...
        if($('#parteifilter8').is(':checked')) { 
            $('#0').css('fill','rgba(242, 0, 30,1.0)')
            $('#1').css('fill','rgba(242, 0, 30,0.85)')
            $('#2').css('fill','rgba(242, 0, 30,0.7)')
            $('#3').css('fill','rgba(242, 0, 30,0.6)')
            $('#4').css('fill','rgba(242, 0, 30,0.55)')
            $('#5').css('fill','rgba(242, 0, 30,0.5)')
            $('#6').css('fill','rgba(242, 0, 30,0.45)')
            $('#7').css('fill','rgba(242, 0, 30,0.4)')
            $('#8').css('fill','rgba(242, 0, 30,0.3)')
            $('#9').css('fill','rgba(242, 0, 30,0.35)')
            $('#10').css('fill','rgba(242, 0, 30,0.2)')
            $('#11').css('fill','rgba(242, 0, 30,0.25)')            
        }
    });
});