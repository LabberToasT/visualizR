...
$(document).ready(function(e) {   
    ...
    $('input').click(function() {
        ...
        if($('#parteifilter2').is(':checked')) {
            ...
            $('#3').css('fill','rgba(0,0,0,0.5)') 
            $('#4').css('fill','rgba(0,0,0,1.0)') 
            $('#5').css('fill','rgba(0,0,0,0.7)') 
            $('#6').css('fill','rgba(0,0,0,0.45)') 
            $('#7').css('fill','rgba(0,0,0,0.35)') 
            $('#8').css('fill','rgba(0,0,0,0.2)') 
            $('#9').css('fill','rgba(0,0,0,0.3)')
            $('#10').css('fill','rgba(0,0,0,0.2)') 
            $('#11').css('fill','rgba(0,0,0,0.55)')         
        }
